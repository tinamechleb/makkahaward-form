                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="text-center">
                            <a href="/" class="logo">
                                <img src="{{asset('images/SM-light.png')}}" alt="" height="22" class="logo-light mx-auto">
                                <img src="{{asset('images/SM.png')}}" alt="" height="22" class="logo-dark mx-auto">
                            </a>
                            <p class="text-muted mt-2 mb-4">Smartest Media | Admin</p>
                        </div>
                        <div class="card">
                                    ...
                                    @if ($errors->any())
                                        <ul class="parsley-errors-list filled" id="parsley-id-5" aria-hidden="false">
                                            @foreach ($errors->all() as $error)
                                                <li class="parsley-required m-0">{{ $error }}</li>
                                            @endforeach
                                        </ul>
                                    @endif
                                    @if (Session::has('error'))
                                        <ul class="parsley-errors-list filled" id="parsley-id-5" aria-hidden="false">
                                            <li class="parsley-required m-0">{{ Session::get('error') }}</li>
                                        </ul>
                                    @endif
                                    </div>
